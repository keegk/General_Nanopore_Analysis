...
**Basecalled, compressed fastq files using fast accuracy Guppy v6.0.1:** /mnt/shared/projects/jhi/bioss/kkeegan_onttestdata/Seal_MinION_analysis/Basecalling_and_fastq/Rebasecalled_jan2023.tar.gz. Within each numbered directory, you will find a  pass subdirectory with a fastq read in it. /mnt/shared/projects/jhi/bioss/kkeegan_onttestdata/Seal_MinION_analysis/Basecalling_and_fastq/Rebasecalled_jan2023 was used as the input path for the bash script concat.fastq.sh, where all the fastq files with 'pass' in their pathname were concatenated together, leaving the failed fastq reads untouched.
