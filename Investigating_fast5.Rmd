...
mydata
```
There are 4095 reads in this file, from channel 442.
...
raw
```
These numbers are the individual pico-amp signals measured by the Nanopore device.
...
*Now repeat the above code, using one of the skip fast5 files*:


```{r loadingdata}
h5ls("fast5/minions_imac_moredun_net_20180123_FAH41635_MN24448_sequencing_run_Seal_mum_pool_30926_read_14515_ch_213_strand.fast5")
```


Looking at the Analyses on this **skip** fast5 file:

```{r}
#h5ls("fast5/minions_imac_moredun_net_20180123_FAH41635_MN24448_sequencing_run_Seal_mum_pool_30926_read_14515_ch_213_strand.fast5")

mydata <- h5read("fast5/minions_imac_moredun_net_20180123_FAH41635_MN24448_sequencing_run_Seal_mum_pool_30926_read_14515_ch_213_strand.fast5", "/Analyses")

mydata
```
No read number is provided (which makes sense if it is a skipped file).

Looking at the raw signal on this **skip** fast5 file:

```{r}
#h5ls("fast5/minions_imac_moredun_net_20180123_FAH41635_MN24448_sequencing_run_Seal_mum_pool_30926_read_14515_ch_213_strand.fast5")

raw <- h5read("fast5/minions_imac_moredun_net_20180123_FAH41635_MN24448_sequencing_run_Seal_mum_pool_30926_read_14515_ch_213_strand.fast5", "/Raw")
...
```{r}
h5dump ("fast5/minions_imac_moredun_net_20180123_FAH41635_MN24448_sequencing_run_Seal_mum_pool_30926_read_14515_ch_213_strand.fast5", all = TRUE)
```

*And finally, examining one of the fail fast5 files*


```{r loadingdata}
h5ls("fast5/minions_imac_moredun_net_20180123_FAH41635_MN24448_sequencing_run_Seal_mum_pool_30926_read_198632_ch_35_strand.fast5")
```


Looking at the Analyses on this **fail** fast5 file:

```{r}
#h5ls("fast5/minions_imac_moredun_net_20180123_FAH41635_MN24448_sequencing_run_Seal_mum_pool_30926_read_198632_ch_35_strand.fast5")

mydata <- h5read("fast5/minions_imac_moredun_net_20180123_FAH41635_MN24448_sequencing_run_Seal_mum_pool_30926_read_198632_ch_35_strand.fast5", "/Analyses")

mydata
```
There are far more reads in this fail file, 198,632, from channel 35.


Looking at the raw signal on this **fail** fast5 file:

```{r}
#h5ls("fast5/minions_imac_moredun_net_20180123_FAH41635_MN24448_sequencing_run_Seal_mum_pool_30926_read_198632_ch_35_strand.fast5")

raw <- h5read("fast5/minions_imac_moredun_net_20180123_FAH41635_MN24448_sequencing_run_Seal_mum_pool_30926_read_198632_ch_35_strand.fast5", "/Raw")

raw
```

The raw signal doesn't appear to differ wildly from the numbers seen in the pass and skip fast5 file.


h5dump -- Enables a user to examine all the contents of an HDF5 file in one go:

```{r}
h5dump ("fast5/minions_imac_moredun_net_20180123_FAH41635_MN24448_sequencing_run_Seal_mum_pool_30926_read_198632_ch_35_strand.fast5", all = TRUE)
```
